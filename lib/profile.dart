import 'package:carnest/settings.dart';
...
void main() => runApp(const MaterialApp(home: ProfileScreen(), debugShowCheckedModeBanner: false));
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const MenuItem(icon: Icons.payment, label: "Payments"),
            const SizedBox(height: 20),
            MenuItem(
