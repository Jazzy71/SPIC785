...
class SuzukiSelectionScreen extends StatefulWidget {
  final String brandName;
  final String brandAsset;

  const SuzukiSelectionScreen({
    super.key,
  ...
  @override
  State<SuzukiSelectionScreen> createState() => _SuzukiSelectionScreenState();
}

class _SuzukiSelectionScreenState extends State<SuzukiSelectionScreen> {
  final TextEditingController _searchController = TextEditingController();

  final List<Map<String, String>> models = const [
    {'name': 'Celerio', 'image': 'assets/celerio.png'},
    {'name': 'Swift', 'image': 'assets/swift.png'},
    {'name': 'WagonR', 'image': 'assets/wagonr.png'},
    {'name': 'Baleno', 'image': 'assets/baleno.png'},
  ];
